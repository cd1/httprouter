...
func TestRouterOPTIONS(t *testing.T) {
	...
	} else if allow := w.Header().Get("Allow"); allow != http.MethodPost+", "+http.MethodOptions {
	...
	if !(w.Code == http.StatusOK) {
		t.Errorf("OPTIONS handling failed: Code=%d, Header=%v", w.Code, w.Header())
	} else if allow := w.Header().Get("Allow"); allow != http.MethodPost+", "+http.MethodGet+", "+http.MethodOptions && allow != http.MethodGet+", "+http.MethodPost+", "+http.MethodOptions {
		t.Error("unexpected Allow header value: " + allow)
	}
...
func TestRouterNotAllowed(t *testing.T) {
	...
	if !(w.Code == http.StatusMethodNotAllowed) {
		t.Errorf("NotAllowed handling failed: Code=%d, Header=%v", w.Code, w.Header())
	} else if allow := w.Header().Get("Allow"); allow != http.MethodPost+", "+http.MethodDelete+", "+http.MethodOptions && allow != http.MethodDelete+", "+http.MethodPost+", "+http.MethodOptions {
		t.Error("unexpected Allow header value: " + allow)
	}
	...
	if allow := w.Header().Get("Allow"); allow != http.MethodPost+", "+http.MethodDelete+", "+http.MethodOptions && allow != http.MethodDelete+", "+http.MethodPost+", "+http.MethodOptions {
		t.Error("unexpected Allow header value: " + allow)
	}
}
